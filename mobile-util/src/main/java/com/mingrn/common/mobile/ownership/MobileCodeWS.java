...
/**
 * <a href="http://www.webxml.com.cn/" target="_blank">WebXml.com.cn</a> <strong>国内手机号码归属地查询WEB服务</strong>，提供最新的国内手机号码段归属地数据，每月更新。<br
 * />使用本站 WEB 服务请注明或链接本站：<a href="http://www.webxml.com.cn/" target="_blank">http://www.webxml.com.cn/</a> 感谢大家的支持！<br
 * />&nbsp;
...
public class MobileCodeWS extends Service {
	...
	public MobileCodeWS() {
		super(_getWsdlLocation(), MOBILECODEWS_QNAME);
	}

	public MobileCodeWS(WebServiceFeature... features) {
		super(_getWsdlLocation(), MOBILECODEWS_QNAME, features);
	}
